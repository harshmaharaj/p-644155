        ...
        <div className="h-full flex flex-col justify-between">
          <div className="flex w-full flex-col items-stretch">
            ...
            <div className="flex gap-5 text-base 2xl:text-lg tracking-[-0.48px] mt-[8%]">
              ...
              <button className="self-stretch bg-[#FC6313] hover:bg-[#FC6313]/90 transition-colors min-w-[136px] 2xl:min-w-[156px] gap-2 overflow-hidden text-white font-medium w-[140px] 2xl:w-[160px] px-5 py-3 2xl:py-4 rounded-[10px]">
                My Project
              </button>
            </div>
          </div>
