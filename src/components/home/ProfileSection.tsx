...
export const ProfileSection = () => {
  return (
    <div className="w-[45%] max-md:w-full max-md:ml-0">
      <div className="bg-[rgba(0,0,0,0.1)] shadow-[32px_0px_108px_rgba(0,0,0,0.5)] grow w-full pt-[120px] pb-[54px] px-[60px] max-md:max-w-full max-md:mt-10 max-md:pt-[100px] max-md:px-5">
        <div>
